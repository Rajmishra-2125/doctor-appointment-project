...
import { updateProfile, updateUserAvatar, reset } from "../../features/auth/authSlice";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden p-6 text-center transition-colors duration-200">
              <div className="relative inline-block mb-4 group">
                ...
                {user.profileImage ? (
                    <img
                      ...
                      alt="Profile"
                      className="w-40 h-40 rounded-full object-cover mx-auto border-4 border-gray-100 dark:border-gray-700 shadow-sm"
                    />
                ) : (
                    <div className="w-40 h-40 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center mx-auto border-4 border-gray-100 dark:border-gray-700 shadow-sm text-gray-400">
              ...
              <h2 className="text-2xl font-bold text-gray-800 dark:text-white">{user.fullname}</h2>
              <p className="text-gray-500 dark:text-gray-400 font-medium uppercase text-sm mt-1 mb-4">
                {user.role}
              </p>
                ...
                <form onSubmit={handleSubmit}>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`w-full pl-10 pr-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all ${
                            isEditing ? "bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white" : "bg-gray-50 dark:bg-gray-900 border-transparent text-gray-500 dark:text-gray-400 cursor-not-allowed"
                          }`}
                        />
                      </div>
                    </div>
                  ...
                  {isEditing && (
                    <div className="mt-8 flex justify-end">
                      ...
                      >
                         {isLoading ? <Spinner /> : <><Save className="w-5 h-5 mr-2" /> Save Changes</>}
                      </button>
                    </div>
                  )}
                </form>

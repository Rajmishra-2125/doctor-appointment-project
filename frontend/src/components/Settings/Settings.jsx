...
const Settings = () => {
  ...
  const confirmDeleteAccount = () => {
    ...
    dispatch(
      deleteAccount({
        confirmationPassword: deletePassword,
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-200 dark:border-gray-700 transition-colors duration-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg text-gray-900 dark:text-gray-100">
                    {user?.fullname}
                  </p>
                </div>
                <div>
              ...
              {[
                {
                  ...
                  icon: Mail,
                  desc: "Receive updates about your appointments via email",
                },
                {
                  key: "push",
                  label: "Push Notifications",
                  icon: Bell,
                  desc: "Receive real-time push notifications on your device",
                },
                {
                  key: "sms",
                ...
                },
                {
                  ...
                  icon: Globe,
                  desc: "Receive news, offers, and promotion updates",
                },
              ].map((item, index) => (
                <div
                  key={item.key}
                  className={`p-6 flex items-center justify-between ${index !== 3 ? "border-b border-gray-100 dark:border-gray-700" : ""}`}
                >
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50 backdrop-blur-sm">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-md w-full p-6 animate-in zoom-in duration-200 border border-gray-200 dark:border-gray-700">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                This action is <strong>irreversible</strong>. Your account will
                be scheduled for permanent deletion in 30 days. You will lose
                access to your appointments and history.
              </p>
